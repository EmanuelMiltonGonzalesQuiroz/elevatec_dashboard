...
const TechnicalDetails = ({ doc, formData }) => {
  const technicalDetails = [
    ...
    [{ content: "Iluminación", colSpan: 2, styles: { halign: 'center', fontStyle: 'bold' } }, { content: " ", colSpan: 2, styles: { halign: 'center', fontStyle: 'bold' } }],
    ...
    [{ content: "Intercomunicador", colSpan: 2, styles: { halign: 'center', fontStyle: 'bold' } }, { content: " ", colSpan: 2, styles: { halign: 'center', fontStyle: 'bold' } }],
    [{ content: "Sintetizador de voz", colSpan: 2, styles: { halign: 'center', fontStyle: 'bold' } }, { content: " ", colSpan: 2, styles: { halign: 'center', fontStyle: 'bold' } }],
    [{ content: "Luz de emergencia", colSpan: 2, styles: { halign: 'center', fontStyle: 'bold' } }, { content: " ", colSpan: 2, styles: { halign: 'center', fontStyle: 'bold' } }],
    ...
    ["Detector", " ", { content: formData['PuertaDetector'] || " ", colSpan: 2, styles: { halign: 'center', fontStyle: 'bold' } }],
